...
The Maven artifact coordinates (`com.google.cloud:google-cloud-beyondcorp-appconnections`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-appconnections:0.9.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-appconnections" % "0.9.0"
```
